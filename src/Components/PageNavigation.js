...
this.changePage = (pageId, PageLength, showPage, prvBtn, nxtBtn, currObj, dom) => {
...
this.nextPage = (CurrentPageId, PageLength, showPage, prvBtn, nxtBtn,  currObj, dom) => {
    ...
    dom.findDOMNode(currObj.refs[showPage + CurrentPageId]).style.display = 'block';
    return CurrentPageId;
  }

  this.previousPage = (CurrentPageId, PageLength, showPage, prvBtn, nxtBtn,  currObj, dom) => {
    if (CurrentPageId == 0) {
      return;
    }
