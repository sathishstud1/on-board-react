                ...
                return (
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      required={fieldData.required}
                    />
                    <label className="form-check-label" for={ids}>
                      {value}
                    </label>
                  </div>
                );
        ...
        case "select":
          ...
          if (link == "countries") {
            ...
            countries.countries.map((cntry, key) => {
              ...
              if (isSelected) {
                if (
                  typeof country.isSelected != "undefined" &&
                  country.isSelected != null
                ) {
                  options.push(
                    <option value={country.abbreviation} selected>
                      {country.country}
                    </option>
                  );
                } else if (
                  typeof country.available != "undefined" &&
                  ...
                  options.push(
                    <option value={country.abbreviation} disabled>
                      {country.country}
                    </option>
                  );
                }
            ...
            countryList.map((countryKey, index) => {
              ...
              options.push(
                <option value={countryObj.value} disabled>
              ...
              statesList.map((stateKey, key) => {
                ...
                if (value && value == state.value) {
                  options.push(
                    <option value={state.value} selected>
                      {state.label}
                    </option>
                  );
                } else {
          ...
          if (
            typeof fieldData.dependent != "undefined" &&
            fieldData.dependent
          ) {
            formfields.push(
              <div className={fieldData.colWidth + " mb-3"}>
